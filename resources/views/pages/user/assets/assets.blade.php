...
@section('content')
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Bidhaa za Store</h1>
									<!--end::Title-->
								</div>
								<!--end::Page title-->
								<!--begin::Actions-->
								<div class="d-flex align-items-center gap-2 gap-lg-3">
                                    ...
                                    <a href="#" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_new_address">Ongeza Aina ya Bidhaa</a>
									<!--end::Primary button-->
                                    <!--begin::Primary button-->
                                    <a href="#" class="btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#kt_modal_new_stock">Ongeza Bidhaa</a>
									<!--end::Primary button-->
								</div>
								<!--end::Actions-->
							</div>
													...
													<tbody class="fw-bolder text-gray-600">
														<tr data-kt-table-widget-4="subtable_template" class="d-none">
															...
															<td class="text-end">
																...
																<div class="text-muted fs-7 fw-bolder" data-kt-table-widget-4="template_total">total</div>
															</td>
															<td class="text-end">
                                                        ...
                                                        @foreach($assets as $asset)
														    <tr>
															<td>
																<a class="text-gray-800 text-hover-primary">{{$asset->name}}</a>
                                                                @foreach($asset->check_ins as $ins)
                                                                    {{$ins->id}}
                                                                @endforeach
															</td>
															<td class="text-end">{{$asset->asset_type->name}}</td>
															<td class="text-end">
																<a href="#" class="text-gray-600 text-hover-primary">{{$asset->quantity}}</a>
															</td>
															<td class="text-end">{{$asset->asset_type->unit}}</td>
															<td class="text-end">
																<span class="text-gray-800 fw-boldest">{{number_format($asset->alert_quantity)}}</span>
															</td>
															<td class="text-end">
																@if($asset->quantity <= $asset->alert_quantity)
															...
															<td class="text-end">
																<button type="button" id="2" class="btn btn-sm btn-icon btn-light btn-active-light-primary toggle h-25px w-25px" data-kt-table-widget-4="expand_row">
		...
		<div class="modal fade" id="kt_modal_new_address" tabindex="-1" aria-hidden="true">
			...
			<div class="modal-dialog modal-dialog-centered mw-650px">
				...
				<div class="modal-content">
					<!--begin::Form-->
					<form method="post" class="form" action="{{route('add_asset')}}" id="kt_modal_new_address_form">
                        @csrf
						<!--begin::Modal header-->
						...
						<div class="modal-body py-10 px-lg-17">
							...
							<div class="scroll-y me-n7 pe-7" id="kt_modal_new_address_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_new_address_header" data-kt-scroll-wrappers="#kt_modal_new_address_scroll" data-kt-scroll-offset="300px">
								...
								<div class="row mb-5">
									...
									<div class="col-md-6 fv-row">
										<!--end::Label-->
										<label class="required fs-5 fw-bold mb-2">Idadi</label>
										<!--end::Label-->
										<!--end::Input-->
										<input type="number" class="form-control form-control-solid" placeholder="" name="quantity" />
										<!--end::Input-->
									</div>
									<!--end::Col-->
								</div>
								...
								<div class="d-flex flex-column mb-5 fv-row">
									...
									<label class="d-flex align-items-center fs-5 fw-bold mb-2">
										<span class="required">Aina Ya Bidhaa</span>
									...
									<!--end::Label-->
									<!--begin::Select-->
									<select name="asset_type_id" data-control="select2" data-dropdown-parent="#kt_modal_new_address" data-placeholder="Select a Country..." class="form-select form-select-solid">
        ...
        <!--begin::Modal - New Address-->
		<div class="modal fade" id="kt_modal_new_stock" tabindex="-1" aria-hidden="true">
			<!--begin::Modal dialog-->
			<div class="modal-dialog modal-dialog-centered mw-650px">
				<!--begin::Modal content-->
				<div class="modal-content">
							...
							<div class="scroll-y me-n7 pe-7" id="kt_modal_new_address_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_new_address_header" data-kt-scroll-wrappers="#kt_modal_new_address_scroll" data-kt-scroll-offset="300px">
								...
								<div class="row mb-5">
									...
									<div class="col-md-6 fv-row">
										...
										<!--end::Label-->
										<!--end::Input-->
										<input type="number" class="form-control form-control-solid" placeholder="" name="last-name" />
										<!--end::Input-->
									</div>
									<!--end::Col-->
								</div>
